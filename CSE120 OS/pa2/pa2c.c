...
void Main()
{
	if (Fork() == 0) {
		...
		if (Fork() == 0) {
			...
			RequestCPUrate(0);			// process 4
			SlowPrintf(2, "444444444444444444");
			RequestCPUrate(0);			// process 4
			SlowPrintf(2, "444444444444444444");
			Exit();
		}
		...
		SlowPrintf(2, "222222222222222222");
		RequestCPUrate(20);				// process 2
		SlowPrintf(2, "222222222222222222");
		Exit();
	}
	...
	if (Fork() == 0) {
	  ...
	  RequestCPUrate(30);				// process 3
		SlowPrintf(2, "333333333333333333");
	...
	SlowPrintf(2, "111111111111111111");
  RequestCPUrate(10);
	SlowPrintf(2, "111111111111111111");
	Exit();
}
