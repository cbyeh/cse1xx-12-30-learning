...
// Question 2 (5pts):
// enumFrom accepts a number n, and creates a stream of the
// numbers [n, n+1, n+2, ...]
...
// Question 3 (5pts):
// map accepts a function f and a stream [x_0, x_1, ....]
...
function tail(thunk_xs) {
  return delay(function () {
    let xs = force(force(thunk_xs).tail);
    return {
      head: xs.head,
      tail: tail(force(thunk_xs).tail)
    }
  });
}
